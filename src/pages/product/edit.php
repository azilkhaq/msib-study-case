...
<div class="page-wrapper">
    ...
    <div class="page-content">
        ...
        <main class="page-main">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="core/process_edit.php" method="post" enctype="multipart/form-data">
                            ...
                            ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="category">
                                                ...
                                                <?php if (mysqli_num_rows($queryCategory) > 0) { ?>
                                                    ...
                                                    ?>
                                                        <option value="<?= $dataCategory['id'] ?>" <?= $dataCategory['id'] == $data['category_id'] ? 'selected' : '' ?>><?= $dataCategory['category_name'] ?></option>
                                                    <?php
                                                    } ?>
                                                <?php } ?>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="condition">
                                                ...
                                                <?php if (mysqli_num_rows($queryCondition) > 0) { ?>
                                                    ...
                                                    ?>
                                                        <option value="<?= $dataCondition['id'] ?>" <?= $dataCondition['id'] == $data['condition_id'] ? 'selected' : '' ?>><?= $dataCondition['condition_name'] ?></option>
                                                    <?php
                                                    } ?>
                                                <?php } ?>
                                            </select>
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="brand">
                                                ...
                                                <?php if (mysqli_num_rows($queryBrand) > 0) { ?>
                                                    ...
                                                    ?>
                                                        <option value="<?= $dataBrand['id'] ?>" <?= $dataBrand['id'] == $data['brand_id'] ? 'selected' : '' ?>><?= $dataBrand['brand_name'] ?></option>
                                                    <?php
                                                    } ?>
                                                <?php } ?>
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Price</label>
                                            <input type="number" name="price" class="form-control" value="<?= $data['price'] ?>" placeholder="Enter price">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
